...
INSERT INTO Comment (ID, DATE_SENT, REPORT, TEXT, AUTHOR_ID, MEDIA_ID, DELETED)
VALUES (3, CURRENT_DATE, FALSE, 'vendo opel corsa', 5, 66732, FALSE);

INSERT INTO Comment (ID, DATE_SENT, REPORT, TEXT, AUTHOR_ID, MEDIA_ID, DELETED)
VALUES (4, CURRENT_DATE, FALSE, 'vendo opel corsa', 5, 66732, FALSE);

INSERT INTO Comment (ID, DATE_SENT, REPORT, TEXT, AUTHOR_ID, MEDIA_ID, DELETED)
VALUES (5, CURRENT_DATE, TRUE, 'vendo opel corsa', 5, 66732, FALSE);

INSERT INTO Comment (ID, DATE_SENT, REPORT, TEXT, AUTHOR_ID, MEDIA_ID, DELETED)
VALUES (6, CURRENT_DATE, TRUE, 'vendo opel corsa', 5, 66732, FALSE);
