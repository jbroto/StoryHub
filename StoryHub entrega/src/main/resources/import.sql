...
'Una aventura cinematográfica completamente nueva, que enfrentará al todopoderoso Kong y al temible Godzilla contra una colosal amenaza desconocida escondida dentro 
de nuestro mundo. La nueva y épica película profundizará en las historias de estos titanes, sus orígenes y los misterios de Isla Calavera y más allá, mientras descubre 
la batalla mítica que ayudó a forjar a estos seres extraordinarios y los unió a la humanidad para siempre.'
,'Godzilla y Kong: El nuevo imperio',0.0 , 'movie',null,4,4,0,0);
--Media user relation
INSERT INTO Media_User_Relation(CALIFICACION, ENDED, FAVORITO, VIENDO, MEDIA_ID, USER_ID)
...
'Ambientada varias generaciones en el futuro tras el reinado de César, en la que los simios son la especie dominante que vive en armonía y los humanos se han visto
 reducidos a vivir en la sombra. Mientras un nuevo y tiránico líder simio construye su imperio, un joven simio emprende un angustioso viaje que le llevará a 
 cuestionarse todo lo que sabe sobre el pasado y a tomar decisiones que definirán el futuro de simios y humanos por igual.'
,'El reino del planeta de los simios',0.0 , 'movie',null,4,4,0,0);
--Media user relation
INSERT INTO Media_User_Relation(CALIFICACION, ENDED, FAVORITO, VIENDO, MEDIA_ID, USER_ID)
...
Al enfrentarse a una elección entre el amor de su vida y el destino del universo conocido, Paul se esfuerza por evitar un futuro terrible que solo él puede prever.'
,'Dune: Parte dos',0.0 , 'movie',null,4,4,0,0);
--Media user relation
INSERT INTO Media_User_Relation(CALIFICACION, ENDED, FAVORITO, VIENDO, MEDIA_ID, USER_ID)
...
,'Godzilla Minus One',0.0 , 'movie',null,4,4,0,0);
--Media user relation
INSERT INTO Media_User_Relation(CALIFICACION, ENDED, FAVORITO, VIENDO, MEDIA_ID, USER_ID)
...
Tras una inesperada reunión con su largamente perdido padre - el desaliñado gato callejero Vic - Garfield y su amigo canino Odie se ven forzados a abandonar 
sus perfectas y consentidas vidas al unirse a Vic en un hilarante y muy arriesgado atraco.'
,'Garfield: La película',0.0 , 'movie',null,4,4,0,0);
--Media user relation
INSERT INTO Media_User_Relation(CALIFICACION, ENDED, FAVORITO, VIENDO, MEDIA_ID, USER_ID)
